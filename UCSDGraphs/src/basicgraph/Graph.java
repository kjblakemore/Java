...
public abstract class Graph {
	...
	public static void main (String[] args) {
		...
		GraphAdjMatrix graphMatrixFromFile = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/testdata/simpletest.map", graphMatrixFromFile);
		System.out.println(graphMatrixFromFile);
		...
		// Testing Part 2 functionality - distance2 code.
		System.out.println("Testing distance-two methods on sample graphs...");
		
		// Test adjacency list.
		System.out.println("Adjacency List");
		for(int v: graphFromFile.getVertices()) {
			List<Integer> vertices = graphFromFile.getDistance2(v);
			System.out.println("2 Hops From " + v + ": " + vertices);
		}
		
		//Test adjacency matrix.
		System.out.println("\nAdjacency Matrix");
		for(int v: graphMatrixFromFile.getVertices()) {
			List<Integer> vertices = graphMatrixFromFile.getDistance2(v);
			System.out.println("2 Hops From " + v + ": " + vertices);
		}
