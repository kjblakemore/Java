...
public class EfficientDocument extends Document {
	...
	{  
		// Separate text into tokens, consisting of words and end-of-sentnence
		// punctuation.  Words consist of alphabetic characters, only.
		List<String> tokens = getTokens("[!?.]+|[a-zA-Z]+");
		
		// Count sentences, words and tokens.
		...
		// Special case for missing end-of-sentence punctuation on last sentence.
